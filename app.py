...
# This saves network download time by caching the raw sheet data for 5 minutes (300 seconds)
@st.cache_data(ttl=300) 
def download_raw_sheet():
    return pd.read_csv(SHEET_URL, dtype=str)

# This handles the data cleaning quickly in-memory without slamming the network
def get_live_data():
